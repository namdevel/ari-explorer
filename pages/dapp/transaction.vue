...
async function fetchTransactions(page) {
  ...
  try {
    const response = await $fetch("https://ari-explorer.lupa.pw/api/dapp/transactions", {
      method: "POST",
      body: payload,
    });
  ...
  <div style="padding-bottom: 50px !important">
    ...
    <div>
      <div class="max-w-4xl mx-auto ari-block text-white pb-5">
        <h5 class="text-xl ari-text font-semibold mb-4 text-center pt-4">DApp Transactions</h5>
